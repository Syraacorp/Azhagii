    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="myEvents.php" class="active">
        ...
        <main class="main-content">
            ...
            <header class="top-bar">
                <div>
                    <h2 style="font-size: 1.25rem; margin: 0;">My Events</h2>
                </div>
            ...
            <div class="card"
                ...
                <div style="padding: 1.5rem; border-bottom: 1px solid var(--border-color);">
                    <h3 style="margin: 0;">Upcoming Registered Events</h3>
                </div>
                <div class="table-responsive" style="border: none; border-radius: 0;">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT e.title, e.event_date, e.event_time, e.location, r.status 
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5' style='text-align:center;'>You have not registered for any upcoming events. <a href='browseEvents.php' style='color: var(--accent-blue);'>Browse Events</a></td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
