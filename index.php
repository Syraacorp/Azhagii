            ...
            <div class="hero-buttons">
                <?php if (!isset($_SESSION['user_id'])): ?>
                    <a href="<?php echo BASE_URL; ?>/register.php" class="btn"
                        style="background: white; color: var(--primary); border: none; font-weight: 700;">
    ...
    <section class="features container">
        ...
        <div class="grid">
            <div class="card" style="text-align: center;">
                ...
                <p class="text-muted">Create, edit, and manage events effortlessly. Keep track of all
            ...
            <div class="card" style="text-align: center;">
                ...
                <p class="text-muted">Allow users to register with a single click. Manage attendee lists
            ...
            <div class="card" style="text-align: center;">
                ...
                <p class="text-muted">Automatically generate and distribute professional certificates to
