    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <header class="top-bar">
                <div>
                    <h2 style="font-size: 1.25rem; margin: 0;">Registrations</h2>
                </div>
            ...
            <div class="card"
                ...
                <div style="padding: 1.5rem; border-bottom: 1px solid var(--border-color);">
                    <h3 style="margin: 0;">Event Registrations</h3>
                </div>
                <div class="table-responsive" style="border: none; border-radius: 0;">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT r.id, u.name, u.regno, e.title, r.registration_date, r.status 
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    $statusClass = $row['status'] == 'registered' ? 'status-success' : 'status-warning';
                                    echo "<tr>";
                                    echo "<td>#{$row['id']}</td>";
                                    echo "<td>{$row['name']}</td>";
                                    ...
                                    echo "<td>
                                            <a href='#' class='btn btn-outline' style='padding: 0.25rem 0.5rem; font-size: 0.8rem;'>Manage</a>
                                          </td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='7' style='text-align:center;'>No registrations found.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
